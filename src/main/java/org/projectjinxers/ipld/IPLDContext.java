...
public class IPLDContext {
     ...
     * @param in     the encoding for submitting data to the IPFS node (IPFS' point
     *               of view)
     * @param out    the encoding for saving data in and reading data from IPFS
     *               (IPFS' point of view)
     * @param eager  indicates whether or not links are to be resolved now (as
