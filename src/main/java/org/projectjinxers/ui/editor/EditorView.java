...
public class EditorView implements PJView<EditorPresenter.EditorView, EditorPresenter>, EditorPresenter.EditorView {
            ...
            editor.markdownProperty().addListener(new ChangeListener<String>() {
                ...
                public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                    if (newValue != null && newValue.trim().length() > 0) {
                        Platform.runLater(() -> {
                            applySkippedAttributes(newValue);
                        });
                    }
                }
            });
    ...
    private void adjustViews(Parent parent, Map<String, AttributesNode> imageAttributes) {
    ...
    private void adjustImageView(ImageView imageView, AttributesNode attributes) {
        double width = 0;
        double height = 0;
